"""Claude API client for Palintir's reasoning engine.
...
SYSTEM_PROMPT = """You are Palintir, an AI classroom assistant mounted on the wall of a classroom. You observe the room through a camera and listen via microphone.
