...
def _check_common(config: PalintirConfig, result: PreflightResult) -> None:
...
def _check_llm_access(config: PalintirConfig, result: PreflightResult) -> None:
...
def _check_web_deps(config: PalintirConfig, result: PreflightResult) -> None:
...
def _check_redis(config: PalintirConfig, result: PreflightResult) -> None:
...
def validate_for(service_name: str, config: PalintirConfig) -> PreflightResult:
